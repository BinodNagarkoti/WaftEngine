...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/news-manage'));
}
...
function* deleteSuccessFunc(action) {
  const snackbarData = {
    message: action.payload.msg || 'News delete success!!',
    options: {
      variant: 'success',
    },
  };
...
export default function* defaultSaga() {
  ...
  yield takeLatest(types.DELETE_ONE_REQUEST, deleteNews);
