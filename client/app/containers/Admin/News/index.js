...
export class NewsManagePage extends React.Component {
  static propTypes = {
  ...
  handleAdd = () => {
    this.props.clearOne();
    this.props.push('/admin/news-manage/add');
  };
  handleEdit = id => {
    this.props.push(`/admin/news-manage/edit/${id}`);
  };
  handleView= slug_url => {
      ...
      ({
        ...
        return [
          ...
          <React.Fragment>
            ...
            {/* <a href={`http://localhost:5051/news/${slug_url}`} target="_blank">
              view news
            </a> */}
            <Tooltip
    ...
    return (
      <>
        ...
        <div className="flex justify-between mt-3 mb-3">
          ...
          <PageHeader>News Manage</PageHeader>
          <Fab
            color="primary"
            aria-label="Add"
