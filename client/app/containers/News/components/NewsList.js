...
import NewsListSkeleton from '../Skeleton/NewsList';

const RenderNews = props => {
  const { currentNews, loading, pagination, handlePagination } = props;
...
export default compose(withConnect)(RenderNews);
